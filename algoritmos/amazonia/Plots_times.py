...
axs[0].set_title('CNN')
axs[0].plot(cnn['Target size'],cnn['Single classifying time (s)'])
axs[0].legend()
...
axs[1].set_title('KNN')
axs[1].scatter(x=knn['Target size'], y=knn['Single classifying time (s)'], s=70, marker='o')
axs[1].legend()
...
axs[2].set_title('RFC')
axs[2].scatter(x=rfc['Target size'], y=rfc['Single classifying time (s)'], s=70, marker='o')
axs[2].legend()
