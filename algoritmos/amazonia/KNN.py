...
targ_shape = (8,8)
dataset_name = 'amazon_data_{}.npz'%(targ_shape[0])
...
def load_dataset():
    ...
    Xtr = Xtr.reshape(Xtr.shape[0], 128 * 128 * 3)  ## Vamos concatenar os dados das 3 dimensoes em apenas 1 dimensão
