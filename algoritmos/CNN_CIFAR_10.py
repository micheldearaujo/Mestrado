# O Objetivo deste programa é utilizar algoritmos de Convolutional Neural Networks
# Para realizar classificação do dataset 'CIFAR-10', ou seja, classificação multiclasse.
# O objetivo primordial é entender como algoritmos CNN funcionam e como usá-los a partir
...
print('A dimensao dos dados sao: ')
print('X treino: ',Xtr.shape)
print('y treino: ',ytr.shape)
print('X teste: ',Xte.shape)
print('y teste: ',yte.shape)
print('X validacao: ',Xval.shape)
print('X validacao: ',yval.shape)
...
modelo.fit(x=Xtr, y=ytr, epochs=10, validation_data=(Xval, yval))
